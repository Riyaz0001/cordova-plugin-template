...
package com.mrustudio.plugin.storagePath;
...
public class StoragePath extends CordovaPlugin {
  public static final String EXTERNAL = "external";
  public static final String INTERNAL = "internal";

  public static final String FIXED_PATH = "Android/data/";
  public static final String SD_CARD = "StoragePath";
...
//      String name = data.getString(0);
      ...
      for (int index = 0; index < storageDirectories.length; index++) {
        if (storageDirectories[index].contains("emulated")) {
          jsonSubobj.put(INTERNAL, "file://" + storageDirectories[index] + File.separator + strDynamicPath + "/");
        } else {
          jsonSubobj.put(EXTERNAL, "file://" + storageDirectories[index] + File.separator + strDynamicPath + "/");
        }
